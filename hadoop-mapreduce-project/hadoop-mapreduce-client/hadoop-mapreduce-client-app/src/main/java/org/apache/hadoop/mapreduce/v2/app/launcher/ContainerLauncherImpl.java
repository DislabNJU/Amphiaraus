...
public class ContainerLauncherImpl extends AbstractService implements
  ...
  //added by lxb;
  @Override
  public List<ContainerStatus> getContainerStatuses() throws YarnException, IOException{
	  LOG.info("getContainerStatuses in ContainerLauncherImpl.");
	  List<ContainerStatus> containerStatuses = new ArrayList<ContainerStatus>();
	  if(containers.isEmpty()){
		  LOG.info("containers is empty!");
	  }
	  for (Map.Entry<ContainerId, Container> entry : containers.entrySet()){
		  if(entry.getValue().isCompletelyDone())
			  continue;
		  LOG.info("Getting containerStatus for container" + entry.getKey());
		  ContainerStatus containerStatus = getContainerStatus(entry.getKey(), entry.getValue().getMgrAddress());
  ...
  public ContainerStatus getContainerStatus(ContainerId containerId,
		  String containerMgrAddress) throws YarnException, IOException {
