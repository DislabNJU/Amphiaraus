...
public class ApplicationMaster {
  ...
  //private tempThreadToShowContainerStatuses tempThread;
  /**
  ...
  public void run() throws YarnException, IOException {
    ...
    //added by lxb;
    //this.tempThread = new tempThreadToShowContainerStatuses();
  ...
  protected boolean finish() {
    ...
    //this.tempThread.interrupt();  //added by lxb
    return success;
  }
  ...
  //added by lxb
  private class tempThreadToShowContainerStatuses extends Thread{
	    public tempThreadToShowContainerStatuses() {
	        super("tempThreadToShowContainerStatuses");
	      }
	    
	    @Override
	    public void run(){
	    	while(true){
	    		LOG.info("tempThreadToShowContainerStatuses tring to show containerDetails." );
	    		ConcurrentMap<ContainerId, Container> runningContainers = containerListener.getContainers();
	    		for (Map.Entry<ContainerId, Container> entry : runningContainers.entrySet()){
	    			try{
	    				ContainerStatus containerStatus = nmClientAsync.getClient().getContainerStatus(entry.getKey(), entry.getValue().getNodeId());
	    				LOG.info("tempThreadToShowContainerStatuses" + containerStatus.toString());
	    			} catch (Exception e) {
	    				LOG.warn("Uncaught exception in tempThreadToShowContainerStatuses "
	    						+ "while managing container: " + entry.getKey(), e);
	    			}
	            ...
	            try {
	                ...
	                LOG.warn( "tempThreadToShowContainerStatuses is interrupted. Exiting.");
	                break;
	              }
	    	}
	    }
