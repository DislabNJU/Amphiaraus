...
public abstract class NMContainerStatus {
  ...
  public static NMContainerStatus newInstance(ContainerId containerId,
      ContainerState containerState, ContainerDetails containerDetails, Resource allocatedResource,
    ...
    status.setContainerDetails(containerDetails); //added by lxb;
  ...
  //added by lxb;
  public abstract ContainerDetails getContainerDetails();
  
  public abstract void setContainerDetails(ContainerDetails containerDetails);
}
