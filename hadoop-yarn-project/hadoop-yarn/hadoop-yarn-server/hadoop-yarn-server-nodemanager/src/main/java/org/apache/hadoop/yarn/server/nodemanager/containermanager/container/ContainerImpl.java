...
public class ContainerImpl implements Container {
  ...
  public ContainerImpl(Configuration conf, Dispatcher dispatcher,
    ...
    this.containerDetails = new ContainerDetails();  //added by lxb;
  ...
  public ContainerStatus cloneAndGetContainerStatus() {
    ...
    try {
      return BuilderUtils.newContainerStatus(this.containerId,
        getCurrentState(), this.containerDetails, diagnostics.toString(), exitCode);
    } finally {
      this.readLock.unlock();
    }
  }
  ...
  public NMContainerStatus getNMContainerStatus() {
    this.readLock.lock();
    try {
      return NMContainerStatus.newInstance(this.containerId, getCurrentState(), getContainerDetails(), 
