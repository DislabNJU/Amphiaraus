...
public abstract class ContainerStatus {
  ...
  public static ContainerStatus newInstance(ContainerId containerId,
      ContainerState containerState, ContainerDetails containerDetails, String diagnostics, int exitStatus) {
...
//added by lxb;  
  @Public
  public abstract ContainerDetails getDetails();

  @Private
  public abstract void setDetails(ContainerDetails details);
}
